...
## 1. Back up the Mac and install Debian 13
...
dependencies described in [development](docs/DEVELOPMENT.md):
...
Follow [backup and restore](docs/BACKUP-RESTORE.md) for the exact commands, expected
...
## 9. Rehearse the Supabase migration
...
rollback are in [migration](docs/MIGRATION.md).
...
- The [private admin guide](docs/ADMIN.md) covers the dedicated unprivileged user,
...
- The [dashboard guide](docs/DASHBOARD.md) covers its loopback-only service, bounded
...
| Task | Runbook |
| --- | --- |
| Debian, staging, host templates, and Tailscale | [Installation](docs/INSTALL.md) |
| Docker and Supabase-compatible services | [Data services](docs/DATA-SERVICES.md) |
| Managed Supabase migration | [Migration](docs/MIGRATION.md) |
| Private admin and identity | [Admin](docs/ADMIN.md) · [Identity](docs/ADMIN-IDENTITY.md) |
...
For development and source-only testing, see [development](docs/DEVELOPMENT.md).
